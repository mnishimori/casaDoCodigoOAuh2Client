...
public class CadastroUsuarioController {
    ...
    public ModelAndView registrar(DadosCadastrais dadosCadastrais) {
        ...
        String password = getEncodePassword(dadosCadastrais);
        Usuario usuario = new Usuario(dadosCadastrais.getNome(), dadosCadastrais.getLogin(), password);
    ...
    private String getEncodePassword(DadosCadastrais dadosCadastrais) {
        return passwordEncoder.encode(dadosCadastrais.getSenha());
    }
}
